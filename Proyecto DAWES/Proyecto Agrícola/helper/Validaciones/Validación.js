...
function validarID(){
    ...
    valor=document.getElementById('Parcela').value;

    if(/^(T|L|t|l)\d{4}(I|P|O|V|i|p|o|v)/.test(valor))
    {
        document.getElementById('Parcela').style.border = '1px solid green';
    } else {
        document.getElementById('Parcela').style.border = '1px solid red';
    }
