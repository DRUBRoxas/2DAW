...
<form action="" method="post">
    codigo:<input type="text" name="codigo" class="form-control" required
        value="<?= $valida->getValor('codigo') ?>"><br>
    ...
    Precio Hora:<input type="number" name="precio_hora" class="form-control"
        value="<?= $valida->getValor('precio_hora') ?>"><br>
